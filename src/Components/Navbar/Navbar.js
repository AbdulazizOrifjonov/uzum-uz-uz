...
//                         className='input_in'
//                     />
//                     {inputValue.trim().length > 0 && <button className='d' onClick={handleClearInput}>         <IoIosCloseCircle className='svg' />
//                     </button>
//                     }
// {
//     inputValue.trim() && <div className="navbr_search_dropDovn">
// {
//     data?.map((el)=> <div key={el._id} className='nav__search-item'>
...
//                         placeholder='Mahsulotlar va turkumlar izlash '
//                         className={`input_in ${inputFocused ? 'focused' : ''}`}
//                     />
//                     {inputValue.trim().length > 0 && (
//                         <button className='d' onClick={handleClearInput}>
//                             <IoIosCloseCircle className='svg' />
